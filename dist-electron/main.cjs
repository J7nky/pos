        ...
        try {
            ...
            for (const line of lines) {
                ...
                if (lineHasArabic) {
                    ...
                    const isLarge = trimmedLine.includes('TOTAL BALANCE')||trimmedLine.includes('الرصيد الاجمالي');
                    // Render as image
                    console.log('123 isLarge:', isLarge);
                    ...
                    const bitmapHeight = Math.ceil((isLarge ? 40 : 28) * 1.5 + 20);

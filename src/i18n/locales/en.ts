const en = {
  ...
  pos: { header: 'Point of Sale', newBill: 'New Bill', cartEmpty: 'Cart is empty', products: 'Products', subtotal: 'Subtotal', total: 'Total', customerName: 'Customer Name', walkInCustomer: 'Walk-in Customer', paymentMethod: 'Payment Method', cash: 'Cash', card: 'Card', credit: 'Credit', amountReceived: 'Amount Received', change: 'Change', notesOptional: 'Notes (Optional)', completeSale: 'Complete Sale', processing: 'Processing...', addNewCustomer: 'Add New Customer', searchCustomers: 'Search customers...', searchProducts: 'Search products or suppliers...' },

...
export default function Customers() {
  ...
  const getSafeAmount = (amount: string, currency: 'USD' | 'LBP') => {
    return CurrencyService.getInstance().safeConvertForDatabase(parseFloat(amount), currency);
  };
  ...
  const processPayment = async (
    ...
    try {
      ...
      await updateEntityBalance(entity, entityId, paymentAmount, currency, isCustomer);

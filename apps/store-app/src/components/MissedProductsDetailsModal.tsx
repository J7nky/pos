...
export const MissedProductsDetailsModal: React.FC<MissedProductsDetailsModalProps> = ({
  ...
  return (
    <div className="animate-modal-fade fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="animate-modal-pop bg-white rounded-lg w-full max-w-6xl max-h-[90vh] flex flex-col">
        {/* Header */}
          ...
          {!loading && !error && missedProducts.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">
                No inventory discrepancies were recorded for this session.
              </p>
            </div>
          )}

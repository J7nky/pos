...
export const TRANSACTION_CATEGORIES = {
  ...
  INVENTORY_LOSS_REVERSAL: 'Inventory Loss Reversal',
...
export const CATEGORY_TO_TYPE_MAP: Record<TransactionCategory, TransactionType> = {
  ...
  [TRANSACTION_CATEGORIES.INVENTORY_LOSS]: TRANSACTION_TYPES.EXPENSE,
  // Contra-expense (restores inventory, reduces 5950) — income-type by the same
  // convention as EMPLOYEE_PAYMENT_RECEIVED (which credits 5200 Salaries Expense).
  [TRANSACTION_CATEGORIES.INVENTORY_LOSS_REVERSAL]: TRANSACTION_TYPES.INCOME,

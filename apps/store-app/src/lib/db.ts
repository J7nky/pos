...
class POSDatabase extends Dexie {
  ...
  constructor() {
    ...
    // Version 54: Add entity_id to transactions table (unified field for customer_id, supplier_id, employee_id)
    this.version(54).stores({
      ...
      // UPDATED: Add entity_id index (keep old fields for backward compatibility)

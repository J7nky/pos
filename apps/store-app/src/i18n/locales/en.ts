const en = {
  ...
  common: {
    ...
    labels: {
      ...
      undoActions: {
        ...
        unarchive_inventory_item: 'Inventory item restored',
  ...
  nav: { home: 'Home', inventory: 'Inventory', pos: 'Point of Sale', accounts: 'Accounts', accounting: 'Accounting', reports: 'Reports', unsynced: 'Unsynced Items', settings: 'Settings', employees: 'Employees', auditLog: 'Audit Log' },
  layout: { title: 'ProducePOS', connection: { online: 'Online', offline: 'Offline' }, unsynced: 'unsynced', signOut: 'Sign out' },
  sync: {
    backgroundHydration: 'Finishing background sync (inventory, bills, journals)…',
    outboxPermanentSection: 'Failed uploads (not retried automatically)',
    discardOutbox: 'Remove from queue',
    permissionRevokedTitle: 'Session ended',
    permissionRevokedDetail: 'You no longer have access to this store. Sign in again if your access changed.',
  },
  login: {
  ...
  inventory: {
    ...
    unarchiveSuccess: 'Item restored successfully',
    archiveFailure: 'Failed to archive item',
    unarchiveFailure: 'Failed to restore item',
    noArchivedItems: 'No archived items',
    noArchivedItemsDesc: 'Items you archive from the stock tab will appear here',
    hasReferencesTitle: 'Cannot Delete — Sales Exist',
    hasReferencesDesc: 'This item has {{count}} sale(s) linked to it. Deleting is blocked to protect your financial records. Archive it instead to stop it from being sold.',
    archiveConfirmTitle: 'Archive Inventory Item',
    archiveConfirmDesc: 'This item will be hidden from selling. You can restore it anytime from the Archived tab.',
    deleteConfirmTitle: 'Delete Inventory Item',
    deleteConfirmDesc: 'This item has no sales. It will be permanently removed.',
    permanentDeleteTitle: 'Delete Permanently',
    permanentDeleteDesc: 'This will permanently remove the item. This cannot be undone.',
    selectAll: 'Select All',
    deselectAll: 'Deselect All',
    selectedCount: '{{count}} selected',
    bulkUnarchive: 'Restore Selected',
  ...
  reports: {
    ...
    currentStockLevels: 'Current Stock Levels',
    status: { outOfStock: 'Out of Stock', lowStock: 'Low Stock', inStock: 'In Stock', never: 'Never' },
    trialBalance: {
      title: 'Trial Balance',
      description: 'All GL accounts with debit and credit totals for the selected period. Debits must equal credits.',
      tableTitle: 'Account balances',
      filters: 'Filters',
      quickDateRange: 'Quick date range',
      startDate: 'Start date',
      endDate: 'End date',
      preset: { today: 'Today', week: 'Week', mtd: 'MTD', month: '30 days', year: 'YTD' },
      ...
      errorTitle: 'Failed to load trial balance',
      noEntries: 'No journal entries in this period.',
      totals: 'Totals',
      ...
      accountCount: '{{count}} accounts with activity',
      drillDownTitle: 'Account journal entries',
      drillDownEmpty: 'No journal entries for this account in the selected period.',
      drillDownEntryCount: '{{count}} entries',
      col: {
  ...
  customers: {
    ...
    paymentDirection: {
      ...
      theyPayUs: 'They pay us',
      wePayThem: 'We pay them',
    },
  ...
  losses: {
    ...
    reportSpoilage: 'Report Spoilage',
    reasons: {
      shrinkage: 'Shrinkage',
      spoiled: 'Spoiled / Wasted'
    },
    sources: {
      auto_close: 'Automatic (bill close)',
      manual: 'Manual'
    },
    lossDescription: 'Inventory loss ({{reason}}): {{amount}} {{product}}',
    quantityLost: 'Quantity lost',
    notes: 'Notes',
    notesPlaceholder: 'Optional note (e.g. box fell off the truck)',
    lossValue: 'Loss value',
    onHand: 'On hand',
    confirmLoss: 'Record Loss',
    recording: 'Recording...',
    commissionNotice: 'Commission lot — recorded as a note only; the loss belongs to the supplier and does not affect your books.',
    cannotExceedOnHand: 'Cannot record a loss greater than the on-hand quantity',
    quantityRequired: 'Enter a quantity greater than zero',
    lossRecorded: 'Loss recorded',
    lossRecordFailed: 'Recording the loss failed',
    unaccountedUnits: 'Unaccounted units',
    autoClassifyNotice: 'These units will be recorded as spoiled automatically when this bill is closed',
    shrinkagePreview: 'Weight shrinkage to record on close',
    estimatedLoss: 'Estimated loss',
    received: 'Received',
    sold: 'Sold',
    recordedLosses: 'Recorded losses',
    remainingWeight: 'Remaining weight',
    weightRequired: 'Weight is required for this weight-tracked item',
    weightTracked: 'Weight tracked',
    weightTrackedHint: 'Weight will be required on every sale of this item',
    reverse: 'Reverse',
    reversed: 'Reversed',
    reversalOf: 'Reversal of',
    confirmReverse: 'Reverse this loss? Stock will be restored and the accounting entry reversed.',
    lossReversed: 'Loss reversed',
    lossReverseFailed: 'Reversing the loss failed',
    restore: 'Restore',
    confirmRestore: 'Restore this loss? The stock will be put back and the loss removed.',
    lossRestored: 'Loss restored',
    lossRestoreFailed: 'Restoring the loss failed',
    auditSpoiled: '{{count}} items spoiled',
    auditRestored: '{{count}} items spoiled restored',
    ...
    bySupplier: 'By supplier/bill',
    noLosses: 'No losses recorded',
    shrinkageAnomaly: 'Sold weight exceeds received weight for this lot — flagged for review, no shrinkage booked'
  },
  payments: {
    changingDirectionNote: '(payment ⇆ refund)',
    corrected: 'Corrected',
  ...
  auditLog: {
    ...
    startDate: 'Start date',
    endDate: 'End date',
    preset: { today: 'Today', week: 'Last 7 days', mtd: 'Month to date', month: 'Last 30 days', year: 'This year' },
    user: 'User',
    allUsers: 'All users',
    action: 'Action',
    entityType: 'Type',
    ...
    columns: { time: 'When', user: 'Who', action: 'Action', entity: 'Record', reference: 'Reference', details: 'Changes', reason: 'Summary' },
    actions: {
    ...
    inventorySummary: {
      received: 'Inventory bill received ({{count}} item(s), {{type}})',
      types: { cash: 'cash', credit: 'credit', commission: 'commission' },
    },
    paymentSummary: {
      entityPayment: '{{entityType}} payment {{direction}}: **{{amount}} {{currency}}** ({{name}})',
      entityTypes: { customer: 'customer', supplier: 'supplier' },
      directions: { received: 'received', sent: 'sent' },
    },
    fieldChange: '{{field}}: {{old}} → {{new}}',
    emptyValue: '(empty)',
    changeCount: '{{count}} field(s) changed',
    noLogs: 'No activity found for the selected filters.',
    loadMore: 'Load more',
    showingCount: 'Showing {{count}} entries',
    scope: {
      cashier: 'You are viewing your own activity.',
      manager: 'You are viewing activity for your branch.',
      admin: 'The activity across the whole store.',
    },
    history: {
      title: 'Change history',
      none: 'No recorded changes for this record.',
    ...
    view: {
      ...
      search: 'Search actor, record or change…',
      emptyHint: 'Try widening the date range or resetting filters.',
      noMatch: 'No entries match your search.',
      referenceHint: 'Show every entry for this reference',
    },
  },
};

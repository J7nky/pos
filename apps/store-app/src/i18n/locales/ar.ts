...
const ar = {
  ...
  payments: {
    ...
    // تحذيرات تغيير الكيان
    warning: 'تحذير',
    entityChangeWarning: 'أنت تقوم بتغيير الدفعة من {{oldEntity}} إلى {{newEntity}}',
    entityChangeNote: 'سيؤدي هذا إلى إزالة الدفعة من حساب الكيان السابق وإضافتها إلى حساب الكيان الجديد. سيتم تحديث كلا الرصيدين وفقًا لذلك.',

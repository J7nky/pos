const fr = {
  ...
  inventory: {
    ...
    categoryTropicalFruits: 'Fruits tropicaux',
  ...
  reports: {
    ...
    balanceSheet: {
      ...
      accounts: {
        ...
        '1300': 'Stock',
        '1400': 'Charges payées d\'avance',
        '1500': 'Équipement',
        '2100': 'Comptes fournisseurs',
        '2200': 'Salaires à payer',
        '2300': 'Emprunts à court terme',
        '3100': 'Capitaux propres',
        '3200': 'Bénéfices non répartis',
        '4100': 'Revenus de ventes',
        '4200': 'Revenus de services',
        '4300': 'Autres revenus',
        '5100': 'Coût des marchandises vendues',
        '5200': 'Charges salariales',
        '5300': 'Charges de loyer',
        '5400': 'Charges de services publics',
        '5500': 'Fournitures de bureau',
        '5600': 'Charges marketing',
        '5700': 'Honoraires professionnels',
        '5800': 'Frais bancaires',
        '5900': 'Charges diverses',
        '5950': 'Pertes de stock / Freinte',
        CYE: 'Bénéfices de l\'exercice',
      },
    },
  },
  ...
  customers: {
    paymentDirection: {
      paymentDirection: 'Direction du paiement',
      theyPayUs: 'Ils nous paient',
      wePayThem: 'Nous leur payons',
    },
    ...
    /** Parametric — pass `{ currency }`. */
    initialBalanceFor: 'Solde initial {{currency}}',
    /** Parametric — pass `{ currency }`. */
    maxBalanceFor: 'Solde maximum {{currency}} (Optionnel)',
    /** Parametric — pass `{ currency }`. */
    advanceFor: 'Avance {{currency}}',
    /** Parametric — pass `{ currency }`. */
    totalAdvancesFor: 'Total avances {{currency}}',
  ...
  losses: {
    title: 'Pertes de stock',
    reportSpoilage: 'Signaler une avarie',
    reasons: {
      shrinkage: 'Freinte (perte de poids)',
      spoiled: 'Avarié / Gaspillé'
    },
    sources: {
      auto_close: 'Automatique (clôture de facture)',
      manual: 'Manuel'
    },
    lossDescription: 'Perte de stock ({{reason}}) : {{amount}} {{product}}',
    quantityLost: 'Quantité perdue',
    notes: 'Notes',
    notesPlaceholder: 'Note facultative (ex. : caisse tombée du camion)',
    lossValue: 'Valeur de la perte',
    onHand: 'En stock',
    confirmLoss: 'Enregistrer la perte',
    recording: 'Enregistrement...',
    commissionNotice: 'Lot en commission — enregistré comme note uniquement ; la perte incombe au fournisseur et n\'affecte pas vos comptes.',
    cannotExceedOnHand: 'Impossible d\'enregistrer une perte supérieure au stock disponible',
    quantityRequired: 'Saisissez une quantité supérieure à zéro',
    lossRecorded: 'Perte enregistrée',
    lossRecordFailed: 'Échec de l\'enregistrement de la perte',
    unaccountedUnits: 'Unités non justifiées',
    autoClassifyNotice: 'Ces unités seront automatiquement enregistrées comme avariées à la clôture de cette facture',
    shrinkagePreview: 'Freinte de poids à enregistrer à la clôture',
    estimatedLoss: 'Perte estimée',
    received: 'Reçu',
    sold: 'Vendu',
    recordedLosses: 'Pertes enregistrées',
    remainingWeight: 'Poids restant',
    weightRequired: 'Le poids est requis pour cet article suivi au poids',
    weightTracked: 'Suivi au poids',
    weightTrackedHint: 'Le poids sera requis à chaque vente de cet article',
    reverse: 'Annuler',
    reversed: 'Annulée',
    reversalOf: 'Annulation de',
    confirmReverse: 'Annuler cette perte ? Le stock sera restauré et l\'écriture comptable contre-passée.',
    lossReversed: 'Perte annulée',
    lossReverseFailed: 'Échec de l\'annulation de la perte',
    restore: 'Restaurer',
    confirmRestore: 'Restaurer cette perte ? Le stock sera rétabli et la perte supprimée.',
    lossRestored: 'Perte restaurée',
    lossRestoreFailed: 'Échec de la restauration de la perte',
    auditSpoiled: '{{count}} articles avariés',
    auditRestored: '{{count}} articles avariés restaurés',
    ...
    bySupplier: 'Par fournisseur/facture',
    noLosses: 'Aucune perte enregistrée',
    shrinkageAnomaly: 'Le poids vendu dépasse le poids reçu pour ce lot — signalé pour vérification, aucune freinte enregistrée'
  },
  payments: {
    changingDirectionNote: '(paiement ⇆ remboursement)',
    corrected: 'Corrigé',
    superseded: 'Remplacé',
    original: 'Original',
    ...
    paymentReceivedFrom: 'Paiement reçu de {{entityName}}',
    paymentSentTo: 'Paiement envoyé à {{entityName}}',
    employeePayment: 'Paiement employé',
    unknown: 'Inconnu',
    amount: 'Montant',
    description: 'Description',
